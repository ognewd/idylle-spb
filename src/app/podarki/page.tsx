  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        queryParams.set('category', 'podarki');
        ...
        const [productsResponse, filtersResponse] = await Promise.all([
          ...
          fetch('/api/filters?category=podarki'),
        ]);
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="max-w-2xl text-white">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium uppercase tracking-wider">Подарки</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-100 mb-8 max-w-xl">
              Идеальные подарки для ваших близких - ароматы и товары для дома, которые создадут незабываемые впечатления
            </p>
              ...
              <CardContent className="p-6">
                <div className={`space-y-4 text-muted-foreground ${!isDescriptionExpanded ? 'line-clamp-3' : ''}`}>
                  <p className="leading-relaxed">
                    Каждый подарок - это выражение ваших чувств и заботы. Мы предлагаем эксклюзивную коллекцию ароматов 
                    и товаров для дома, которые станут незабываемым подарком для ваших близких.
                  </p>

                  <p className="font-medium text-foreground">
                    Премиальные ароматы, элегантная упаковка и внимание к деталям - всё для того, чтобы ваш подарок 
                    вызвал восторг и надолго запомнился.
                  </p>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="lg:w-64 flex-shrink-0">
              ...
              >
                <ProductFilters filters={filters} basePath="/podarki" />
              </div>
            </aside>
