...
export default function NewProductPage() {
  ...
  const handleInputChange = (field: keyof ProductFormData, value: string | boolean) => {
    ...
    // Auto-generate slug from name with transliteration support
  ...
  // Function to manually regenerate slug from name
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Diptyque Philosykos Eau de Toilette"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      title="Регенерировать slug из названия"
                    >
                  ...
                  <p className="text-xs text-muted-foreground">
                    Автоматически генерируется из названия. Поддержка русского языка.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Green, woody fragrance with fig notes"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="A green, woody fragrance capturing the scent of fig trees in the sun..."
                  rows={4}
                />
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Woody, Oriental, Fruity"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Alcohol, Aqua, Parfum, Fig Leaf, Fig Fruit, Cedar, Sandalwood"
                  rows={3}
                />
              </div>
