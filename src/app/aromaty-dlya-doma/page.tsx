  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        queryParams.set('category', 'aromaty-dlya-doma');
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="max-w-2xl text-white">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium uppercase tracking-wider">Коллекция для дома</span>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="lg:w-64 flex-shrink-0">
              ...
              >
                <ProductFilters filters={filters} basePath="/aromaty-dlya-doma" />
              </div>
            </aside>
...
export default function HomeAromasPage() {
  return (
    <Suspense fallback={
